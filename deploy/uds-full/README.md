...
3. **keycloak-portal** (`0.1.30`) — the app (built from `../zarf`).
...
This produces `uds-bundle-keycloak-portal-stack-<arch>-0.1.30.tar.zst` — the
...
- **Versions are pinned** here (init `v0.39.0`, Core `0.40.0`, app `0.1.30`). Bump
